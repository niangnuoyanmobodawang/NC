...
//    	mods.add(new FightGod());
        mods.add(new ClickGUI());
        mods.add(new GUI());
    	mods.add(new NoFireRender());
        ...
        mods.add(new TestingAura());
        mods.add(new Reach());
   //     mods.add(new HackerFinder());
   //     mods.add(new Strafe());
        mods.add(new PingSpoof());
        mods.add(new TestSpeed());
        mods.add(new AutoRespawn());
        mods.add(new XRAY());
      //  mods.add(new ViewClip());
    //    mods.add(new InstantPickup());
        mods.add(new FastLadder());
        mods.add(new AntiCactus());
