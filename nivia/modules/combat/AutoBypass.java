...
public class AutoBypass extends Module{
    ...
    public AutoBypass() {
        ...
        public void onPre (EventPreMotionUpdates e){
	        if (Helper.mc().getCurrentServerData().serverIP.toLowerCase().contains("hypixel") && Lock.value){
        ...
        public void onEnable(){
            ...
            if (Helper.mc().getCurrentServerData().serverIP.toLowerCase().contains("mineplex")) {
                Logger.logChat("|-----------***-----------|");
