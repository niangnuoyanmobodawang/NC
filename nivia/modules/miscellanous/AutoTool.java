...
public class AutoTool extends Module {
	public AutoTool() {
		super("AutoTool&InstantPickup", 0, 0x005C00, Category.MISCELLANEOUS, "Automatically switches to the best weapon and tool",
				new String[] { "asword", "atool", "autot" }, true);
	}
	public DoubleProperty InstantPickup = new DoubleProperty(this, "InstantPickupPackets", 50, 0, 300);
    ...
    public void onPreTick(EventTick e) {
            ...
            if (items != null) {
                for (int i = 0; i < InstantPickup.getValue(); ++i) {
