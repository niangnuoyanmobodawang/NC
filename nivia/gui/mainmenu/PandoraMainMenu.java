...
public class PandoraMainMenu extends GuiScreen {
    ...
    public void initGui() {
         ...
         this.buttons.add(new CircleButton(6, scaledRes.getScaledWidth() / 2 ,
                 scaledRes.getScaledHeight() / 4 + scaledRes.getScaledHeight() / 2.77f - 80, scaledRes.getScaledHeight() / 8, "ÍøÒ×(²âÊÔ)",
                 new Color(108, 158, 255), new ResourceLocation("textures/pandora/tick.png"), true,
                new Hycn()));  
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawString(this.fontRendererObj, s2, res.getScaledWidth() - this.fontRendererObj.getStringWidth(s2) - 2, res.getScaledHeight() - 10, -1);
        final String s3 = "Edited by ho3";
        this.drawString(this.fontRendererObj, s3, res.getScaledWidth() - this.fontRendererObj.getStringWidth(s3) - 2, res.getScaledHeight() - 0, -1);
