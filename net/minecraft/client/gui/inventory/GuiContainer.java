...
import nivia.modules.combat.AutoSoup;
import nivia.modules.combat.KillAura;
import nivia.modules.combat.TestingAura;
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        for (Object object : this.buttonList) {
            ...
            if (guiButton.mousePressed(this.mc, mouseX, mouseY)) {
            	Pandora.getModManager().getModule(TestingAura.class).setState(false);
                ...
                Pandora.getModManager().getModule(AutoSoup.class).setState(false);
            }
        }
