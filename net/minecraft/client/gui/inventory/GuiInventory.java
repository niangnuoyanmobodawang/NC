...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        GlStateManager.color(10.0F, 10.0F, 10.0F, 10.0F);
        if(Helper.ClearBagRP)  this.mc.getTextureManager().bindTexture(inventoryBackground);
       int var4 = this.guiLeft;
        int var5 = this.guiTop;
 	/*   if(!Helper.ClearBag) */if(Helper.ClearBagRP)  this.drawTexturedModalRect(var4, var5, 0, 0, this.xSize, this.ySize);
