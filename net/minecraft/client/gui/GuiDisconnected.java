...
public class GuiDisconnected extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(1337, this.width / 2 - 100, this.height / 2 + this.field_175353_i / 2 + this.fontRendererObj.FONT_HEIGHT + 25, "Reconnect"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.id == 0)
        {
        	...
        	mc.displayGuiScreen(new GuiConnecting(this.parentScreen, mc, Helper.mc().getLastServerData()));     
    }
