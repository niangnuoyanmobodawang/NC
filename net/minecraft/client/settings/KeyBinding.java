...
public class KeyBinding implements Comparable
{
    ...
    public boolean isKeyReallyDown() {
        ...
        return this.keyCode >= 1 && !(Helper.mc().currentScreen instanceof GuiChat) && !(Helper.mc().currentScreen instanceof GuiConnecting) && !(Helper.mc().currentScreen instanceof GuiDisconnected) && this.keyCode != Helper.mc().gameSettings.keyBindSneak.keyCode && (this.pressed = Keyboard.isKeyDown(this.keyCode));
    }
    
    public boolean getIsKeyPressed() {
        return (Helper.invmove && Helper.mc().currentScreen != null) ? this.isKeyReallyDown() : this.pressed;
    }
