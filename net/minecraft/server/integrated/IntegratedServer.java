...
public class IntegratedServer extends MinecraftServer
{
    ...
    public IntegratedServer(Minecraft mcIn) throws Exception
    {
    ...
    public IntegratedServer(Minecraft mcIn, String folderName, String worldName, WorldSettings settings) throws Exception
    {
