...
public abstract class MinecraftServer implements ICommandSender, Runnable, IThreadListener, IPlayerUsage
{
    ...
    public MinecraftServer(Proxy p_i46053_1_, File p_i46053_2_) throws Exception
    {
    ...
    public MinecraftServer(File workDir, Proxy proxy, File profileCacheDir) throws Exception
    {
